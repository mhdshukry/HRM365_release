...
if (in_array($status_filter, ['Active', 'On Leave', 'Resigned', 'Terminated'], true)) {
    $where[] = 'e.status = ?';
...
<div class="card">
    <form method="GET" style="display: flex; gap: 0.75rem; align-items: end; justify-content: flex-end; margin-bottom: 1.5rem;">
        <div>
            ...
            <select name="branch_id" style="padding: 0.6rem; border-radius: var(--radius-md); border: 1px solid var(--border-color); background: var(--bg-secondary); color: var(--text-primary); outline: none;">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <div style="font-size: 0.72rem; color: var(--text-muted);"><?php echo htmlspecialchars($e['branch_name'] ?? 'No Branch'); ?></div>
                    ...
                    <td style="text-align: right;">
                        <form action="save.php" method="POST" style="margin: 0; display: flex; gap: 0.5rem; justify-content: flex-end; align-items: center;">
                            ...
                            <select name="shift_id" title="Normal employee shift" style="padding: 0.4rem; border-radius: var(--radius-md); border: 1px solid var(--border-color); background: var(--bg-secondary); color: var(--text-primary); outline: none; font-size: 0.85rem;">
