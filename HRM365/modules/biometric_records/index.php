...
<div class="page-header">
    ...
    <div style="display: flex; gap: 1rem; align-items: center;">
        ...
        <form action="simulate.php" method="POST" style="margin: 0;">
            <input type="hidden" name="date" value="<?php echo htmlspecialchars($date_filter); ?>">
            <button type="submit" class="btn" style="background: var(--bg-hover); color: var(--text-primary);" title="Inject test data">
                <i class="fas fa-flask"></i> Simulate Device Push
            </button>
        </form>

        <form action="sync.php" method="POST" style="margin: 0;">
            <input type="hidden" name="date" value="<?php echo htmlspecialchars($date_filter); ?>">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($p['log_status'] === 'Clock In'): ?>
                            <span style="color: var(--accent-success); font-size: 0.85rem;"><i class="fas fa-sign-in-alt"></i> Clock In</span>
                        <?php elseif ($p['log_status'] === 'Clock Out'): ?>
                            <span style="color: var(--accent-warning); font-size: 0.85rem;"><i class="fas fa-sign-out-alt"></i> Clock Out</span>
